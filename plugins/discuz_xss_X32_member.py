...
class Exploit:
    ...
    def attack(self, url):
        ...
        if response.status_code == 200 and "javascript://www.discuz.net/testvul" in response.content:
            retList.append(verify_url)
        if response2.status_code == 200 and "javascript://www.discuz.net/testvul" in response2.content:
